...
import type { EventAttachment } from "@/features/calendar/types";
 ...
 */
function getFileIcon(fileType: EventAttachment["fileType"]): React.ComponentProps<typeof Ionicons>["name"] {
  switch (fileType) {
    case "document":
