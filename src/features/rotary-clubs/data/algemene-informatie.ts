/**
 * Algemene Informatie section data
 */

import type { SectionPageContent } from "@/features/rotary-clubs/types";

export const algemeneInformatieContent: SectionPageContent = {
...
Leeftijd - voor de uitzending en ontvangst van de scholier gelden indicatieve leeftijdsgrenzen. In principe is dit 15½ - 18½ jaar.`,
    ...
    },
    {
      id: "kosten",
      title: "Kosten",
      content: `Voor supporten van een Nederlandse scholier naar het buitenland zijn er geen kosten verbonden voor jullie club. Wel zijn er kosten voor de ontvangst van een jaarstudent. (Dit programma is op basis van wederkerigheid, dus het een kan niet zonder het ander plaatsvinden).
