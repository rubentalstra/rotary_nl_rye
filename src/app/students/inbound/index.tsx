...
import { longTermContacts } from "@/features/contacts/data/long-term";
    ...
    () => [
      {
        ...
        icon: "calendar-alt" as FontAwesome5SolidIconName,
    ...
    () => [
      {
        ...
        icon: "campground" as FontAwesome5SolidIconName,
      ...
      },
      {
        ...
        icon: "home" as FontAwesome5SolidIconName,
