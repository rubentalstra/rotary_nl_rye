...
import FontAwesome5, { type FontAwesome5SolidIconName } from "@react-native-vector-icons/fontawesome5";
    ...
    ({ item }: { item: MenuItem }) => (
      ...
      >
        <View style={styles.menuContent}>
          ...
          >
            <FontAwesome5 iconStyle="solid" name={item.icon} size={22} color={themeColors.primary} />
          </View>
    ...
    () => [
      {
        ...
        icon: "users" as FontAwesome5SolidIconName,
    ...
    () => [
      {
        ...
        icon: "edit" as FontAwesome5SolidIconName,
      ...
      },
      {
        ...
        icon: "calendar-day" as FontAwesome5SolidIconName,
      ...
      },
      {
        ...
        icon: "calendar-week" as FontAwesome5SolidIconName,
      ...
      },
      {
        ...
        icon: "globe-americas" as FontAwesome5SolidIconName,
      ...
      },
      {
        ...
        icon: "shield-alt" as FontAwesome5SolidIconName,
