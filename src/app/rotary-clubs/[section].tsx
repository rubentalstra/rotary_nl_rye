...
import { SectionPageView } from "@/components/rotary-clubs/SectionPageView";
import {
  useClubSection,
  useSectionContent,
} from "@/features/rotary-clubs/hooks/use-rotary-clubs";
...
export default function RotaryClubsSectionScreen() {
  ...
  const handleDocumentPress = useCallback((pdfUrl: string, title: string) => {
    // Cast: typed-routes regenerates on the next Metro reload.
    router.push({
      pathname: "/pdf-viewer",
